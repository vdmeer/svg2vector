...
/**
 * Application option "use-layer-index".
 *
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v1.2.0-SNAPSHOT build 170410 (10-Apr-17) for Java 1.8
 * @since      v1.1.0
 */
public class AO_UseLayerIndex extends AbstractApplicationOption<String> {
	 ...
	 */
	public AO_UseLayerIndex(boolean required, String longDescription){
	 ...
	 * @throws IllegalArgumentException - if description parameter is empty
	 */
	public AO_UseLayerIndex(boolean required, Character shortOption, String longDescription){
		super("use layer index", longDescription);

		Option.Builder builder = (shortOption==null)?Option.builder():Option.builder(shortOption.toString());
		builder.longOpt("use-layer-index");
