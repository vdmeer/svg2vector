 ...
 * @since      v1.1.0
 */
public class AO_OnePerLayer extends AbstractApplicationOption<String> {
	 ...
	 */
	public AO_OnePerLayer(boolean required, String longDescription){
	 ...
	 * @throws IllegalArgumentException - if description parameter is empty
	 */
	public AO_OnePerLayer(boolean required, Character shortOption, String longDescription){
		super("one file per layer", longDescription);

		Option.Builder builder = (shortOption==null)?Option.builder():Option.builder(shortOption.toString());
		builder.longOpt("one-per-layer");
