...
/**
 * Application option "not-text-as-shape".
 *
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v1.2.0-SNAPSHOT build 170410 (10-Apr-17) for Java 1.8
 * @since      v1.1.0
 */
public class AO_NotTextAsShape extends AbstractApplicationOption<String> {
	 ...
	 */
	public AO_NotTextAsShape(boolean required, String longDescription){
	 ...
	 * @throws IllegalArgumentException - if description parameter is empty
	 */
	public AO_NotTextAsShape(boolean required, Character shortOption, String longDescription){
		super("text nots as shapes", longDescription);

		Option.Builder builder = (shortOption==null)?Option.builder():Option.builder(shortOption.toString());
		builder.longOpt("not-text-as-shape");
